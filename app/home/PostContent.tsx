...
function reactorNames(reactedBy: string[], currentUserId: string): string[] {
  const names = reactedBy.map((id) => (id === currentUserId ? "You" : getPerson(id).name));
...
export default function PostContent({
  ...
  const author = getAdmin(announcement.authorId);
  const reacted = announcement.reactedBy.includes(currentUser.id);
  const names = reactorNames(announcement.reactedBy, currentUser.id);
  ...
  return (
    <div className="postContent">
      <div className="postHeader">
        ...
        <div className="postHeaderText">
          ...
          <div className="postMetaLine">
            <span className="postAuthorRole">{author?.role}</span>
            <span className="mono postTime">POSTED {formatRelativeTime(announcement.postedAt).toUpperCase()}</span>
          </div>
        </div>
      </div>
      ...
      {announcement.media && (
        <div className="media">
          {announcement.media.type === "images" ? (
      ...
      {announcement.media?.type === "images" && lightboxIndex !== null && (
        <ImageLightbox
